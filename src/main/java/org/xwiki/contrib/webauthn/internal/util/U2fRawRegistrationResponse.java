...
/**
 * The registration response produced by the token/key
 */
@Value
class U2fRawRegistrationResponse {
    ...
    U2fRawRegistrationResponse(ByteArray userPublicKey, ByteArray keyHandle,
